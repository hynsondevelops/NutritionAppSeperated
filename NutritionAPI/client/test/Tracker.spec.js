...
import {sampleObject, dailyDietData, sampleFoodPortions} from './data/FoodPortion.js';
...
describe('<Tracker />', function() {
  it('should have a table Selector', function () {
      const wrapper = mount(<Tracker searchedFoods={[sampleFoods]} dailyDiet={sampleProps.dailyDiet} />);
